...
@section('panel')
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-3 col-xs-4">
                <div class="pull-right">
                    {{Form::open(['class' => 'confirm-delete', 'route' => ['subscriber.destroy', $subscriber], 'method' => 'DELETE'])}}
    ...
    <div class="panel-body">
        {!! Form::model($subscriber, ['route' => ['subscriber.update', $subscriber], 'method' => 'PUT']) !!}
        ...
        <table class="table table-bordered table-responsive table-condensed">
            ...
            @foreach ($subscriber->bunches as $bunch)
                <tr>
                    ...
                    <td>
                        {{ link_to_route('subscriber.removeFromBunch', 'Remove', [$subscriber, $bunch], ['class' => 'btn btn-danger btn-block']) }}
                    </td>
                </tr>
            @endforeach
        </table>

        {{--Add to other bunches--}}
        {!! Form::open(['class' => 'confirm-delete', 'route' => ['subscriber.addToBunch', $subscriber], 'method' => 'POST']) !!}
        <table class="table table-bordered table-responsive table-condensed">
